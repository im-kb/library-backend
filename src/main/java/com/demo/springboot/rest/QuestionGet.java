...
public class QuestionGet {
    ...
    public ResponseEntity<Questions>test(@PathVariable("id") Integer id){
        id=id-1;// zeby sie zgadzaly indexy XDDD

        ArrayList<Questions> quiz = new ArrayList<Questions>(QuizCode.readData());
        final Questions quizValues = new Questions(
        ...
        return new ResponseEntity<Questions>(quizValues,HttpStatus.OK);
    }
}
