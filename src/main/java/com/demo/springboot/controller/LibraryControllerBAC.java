...
//
//public class LibraryControllerBAC {
//
//    ArrayList<BookDto> ksiazki = new ArrayList<BookDto>(getBooks());
//    ArrayList<PublishingHouseDto> wydawnictwa = new ArrayList<PublishingHouseDto>(getWydawnictwo());
//    ArrayList<AuthorDto> autorzy = new ArrayList<AuthorDto>(getAutors());
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(LibraryControllerBAC.class);
//
...
//    public @ResponseBody
//    ResponseEntity<ArrayList<RentedBooksDto>> returnWypozyczeniaKlienta(@RequestParam(value = "login", required = true) String login, @RequestParam(value = "password", required = true) String password) {
//        try {
//            ArrayList<RentedBooksDto> rentedBooksDto = new ArrayList<RentedBooksDto>(getWypozyczeniaKlienta(login, password));
//            return new ResponseEntity<ArrayList<RentedBooksDto>>(rentedBooksDto, HttpStatus.OK);
//        } catch (
//                Exception e) {
//            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
//        }
...
//    public ResponseEntity test10(@RequestBody PublishingHouseDto wydawnictwoValues) {
//        if (addWydawnictwo(wydawnictwoValues.getName(), wydawnictwoValues.getCity()) != 0) {
//            LOGGER.info(wydawnictwoValues.toString());
//            LOGGER.info("dodano wydawnictwo.");
//            refreshWydawnictwa();
//            LOGGER.info("odswiezono wydawnictwa.");
//
//            return new ResponseEntity<PublishingHouseDto>(wydawnictwoValues, HttpStatus.OK);
//        } else
...
//        wydawnictwa = new ArrayList<PublishingHouseDto>(getWydawnictwo());
//    }
//
...
//    public @ResponseBody
//    ResponseEntity<ArrayList<PublishingHouseDto>> returnWydawnictwa() {
//        try {
//            ArrayList<PublishingHouseDto> wydawnictwoData = wydawnictwa;
//
//            return new ResponseEntity<ArrayList<PublishingHouseDto>>(wydawnictwoData, HttpStatus.OK);
//        } catch (
//                Exception e) {
//            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
//        }
