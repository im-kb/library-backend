...
//
//public class LibraryServiceBAC {
//    private static ArrayList<BookDto> bookDtoList;
//    private static ArrayList<ClientDto> klientList;
//    private static ArrayList<PublishingHouseDto> wydawnictwoList;
...
//    }
//
//    public LibraryServiceBAC() throws SQLException {
//    }
//
...
//            Logger lgr = Logger.getLogger(LibraryServiceBAC.class.getName());
//            lgr.log(Level.SEVERE, ex.getMessage(), ex);
//        }
//        return bookDtoList;
//    }
//
//    public static ArrayList<RentedBooksDto> getWypozyczeniaKlienta(String login, String password) {//TODO::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//        ArrayList<RentedBooksDto> klientWypozyczeniaList;
...
//                QUERY_RESULT_ROW = columnValue;
//                String[] tab = QUERY_RESULT_ROW.split(SPLIT_CHAR);
//                RentedBooksDto wyp = new RentedBooksDto(tab[0], tab[1], tab[2], tab[3]);
...
//    }
//
//    public static ArrayList<PublishingHouseDto> getWydawnictwo() { //wczytywywanie wydawnictw
...
//                QUERY_RESULT_ROW = columnValue;
//                String[] tab = QUERY_RESULT_ROW.split(SPLIT_CHAR);
//                PublishingHouseDto ks = new PublishingHouseDto(tab[0], tab[1], tab[2]);
